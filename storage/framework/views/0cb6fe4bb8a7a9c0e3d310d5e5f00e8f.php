...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.user.avatar','data' => ['user' => auth()->user(),'size' => '44','class' => 'rounded-2xl shrink-0 ring-1 ring-white/35 shadow-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(auth()->user()),'size' => '44','class' => 'rounded-2xl shrink-0 ring-1 ring-white/35 shadow-sm']); ?>
...
<?php endif; ?>
                        <div class="min-w-0">
                            ...
                            <div class="text-xs opacity-90 mt-1 truncate"><?php echo e(auth()->user()?->email ?? '-'); ?></div>
                        </div>
                    </div>
                </a>
                <?php if (isset($component)) { $__componentOriginald0f1fd2689e4bb7060122a5b91fe8561 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald0f1fd2689e4bb7060122a5b91fe8561 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['variant' => 'ghost','class' => 'app-sidebar__close xl:hidden','ariaLabel' => 'Tutup sidebar','xOn:click' => '$store.ui.closeSidebar()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'ghost','class' => 'app-sidebar__close xl:hidden','aria-label' => 'Tutup sidebar','x-on:click' => '$store.ui.closeSidebar()']); ?>
            ...
            <div class="app-sidebar__list space-y-3">
                <?php $__currentLoopData = $menuGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($visibleItems->isNotEmpty()): ?>
                        <section
                            class="app-sidebar__group rounded-2xl border border-[rgb(var(--c-border))] p-2 <?php echo e($hasActive ? 'is-current bg-zinc-50/70 dark:bg-zinc-900/40' : 'bg-white/70 dark:bg-zinc-950/50'); ?>">
                            <div
                    ...
                    <?php echo e($item['active'] ? 'is-active bg-zinc-50 dark:bg-zinc-900/60 border-[rgb(var(--c-border))]' : ''); ?>

                    <?php echo e($item['open'] ? 'is-open' : ''); ?>

                    <?php echo e($item['indent'] ? 'is-child ml-4' : ''); ?>">
                                        <span
                                            class="app-sidebar__dot h-2.5 w-2.5 rounded-full <?php echo e($item['active'] ? 'bg-[rgb(var(--c-primary))]' : ($item['open'] ? 'bg-[rgb(var(--c-primary)/0.35)]' : 'bg-zinc-300 dark:bg-zinc-700')); ?>"></span>
        ...
        <div class="app-sidebar__mobile xl:hidden px-3 pb-3">
            <div
                ...
                <div class="app-sidebar__mobile-row">
                    <a class="app-sidebar__chip <?php echo e($locale === 'id' ? 'is-active' : ''); ?>"
                        href="<?php echo e(route('locale.set', 'id')); ?>">ID</a>
                    <a class="app-sidebar__chip <?php echo e($locale === 'en' ? 'is-active' : ''); ?>"
                ...
                <div class="mt-2 grid gap-2">
                    <a class="app-sidebar__action app-notif-trigger <?php echo e($hasUnreadNotifications ? 'has-unread' : ''); ?>"
                    ...
                    <form action="<?php echo e(route('logout')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
                            class="app-sidebar__action app-sidebar__action--danger"><?php echo e(__('app.logout')); ?></button>
                    </form>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\ult-fkip-unila\resources\views/components/app/sidebar.blade.php ENDPATH**/ ?>