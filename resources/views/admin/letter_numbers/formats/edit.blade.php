...
<div class="page-admin-doc-formats-edit">
  <header class="admin-page-header">
    <div class="admin-page-heading">
      ...
      <h1 class="admin-page-title">Edit Template Nomor Surat</h1>
  ...
  <div
    ...
    x-data="{
      template: @js(old('template', $format->template)),
      seqPadding: @js(old('seq_padding', $format->seq_padding)),
      sampleSeq: 0,
      unitCode: 'UN26.13',
      unitName: '',
      unitType: '',
  ...
  >
    <x-card class="dn-form-card">
      <form method="POST" action="{{ route('admin.letter_formats.update', $format) }}" class="dn-form">
        @csrf
        @method('PUT')
              ...
              >
                @foreach($units as $u)
                  <option
                    ...
                    @selected((int)$u->id === (int)$format->unit_id)
        ...
        <div class="dn-form__section">
          ...
          <div class="dn-form__grid">
            <div class="dn-field">
              <x-textarea name="template" label="Template" rows="3" required x-model="template">{{ old('template', $format->template) }}</x-textarea>
        ...
        <div class="dn-form__section">
          ...
          <div class="dn-form__grid dn-form__grid--2 dn-form__grid--tight">
            <div class="dn-field">
              <x-input type="number" name="seq_padding" label="Padding default" value="{{ old('seq_padding', $format->seq_padding) }}" min="1" max="10" x-model.number="seqPadding" />
            </div>
