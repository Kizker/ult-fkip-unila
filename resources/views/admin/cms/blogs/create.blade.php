...
@section('content')
<div class="page-admin-cms page-admin-cms-posts-create page-admin-cms-blogs-create" data-cms-page="blogs-create">
  <header class="cms-page-header">
    <div class="cms-page-heading">
      <h1 class="cms-page-title">Tambah Blog</h1>
      <p class="cms-page-subtitle">Buat konten blog publik.</p>
    </div>
  ...
  <x-card class="cms-card cms-form-card">
    <form method="post" action="{{ route('admin.cms.blogs.store') }}" enctype="multipart/form-data" class="cms-form">
      @csrf
      ...
      <div class="cms-form__section cms-form__section--media">
        ...
        <p class="cms-media-lead">Upload cover untuk kartu blog di halaman publik.</p>
          ...
          <div class="cms-media-controls">
            <div class="cms-file">
              <x-file-input
                id="blog_image"
                name="image"
                label="Cover Blog (jpg/png/webp, max 2MB)"
                accept=".jpg,.jpeg,.png,.webp"
              />
            </div>
            <p class="cms-hint">Gambar akan tampil di halaman publik (home, daftar blog, dan detail).</p>
          </div>
        </div>
      </div>
