...
@section('content')
<div
  class="page-admin-cms page-admin-cms-posts-edit page-admin-cms-blogs-edit"
  data-cms-page="blogs-edit"
  data-cms-autosave-url="{{ route('admin.cms.blogs.autosave', $item) }}"
  data-cms-csrf-token="{{ csrf_token() }}"
>
  <header class="cms-page-header">
    <div class="cms-page-heading">
      <h1 class="cms-page-title">Edit Blog</h1>
      <p class="cms-page-subtitle">{{ $item->title_id }}</p>
    </div>
    <div class="cms-page-actions">
      <x-button href="{{ route('admin.cms.blogs.index') }}" variant="ghost">Kembali</x-button>
    </div>
  </header>

  <x-card class="cms-card cms-form-card">
    <form id="cms_post_form" method="post" action="{{ route('admin.cms.blogs.update',$item) }}" enctype="multipart/form-data" class="cms-form">
      @csrf @method('PUT')
      ...
      <div class="cms-form__section cms-form__section--media">
        ...
        <p class="cms-media-lead">Kelola cover blog untuk kartu konten di halaman publik.</p>
          ...
          <div class="cms-media-preview">
            ...
            @else
              <div class="cms-empty cms-cover-empty">
                <span class="cms-cover-empty__title">Belum ada cover blog.</span>
          ...
          <div class="cms-media-controls">
            <div class="cms-file">
              <x-file-input
                id="blog_image"
                name="image"
                label="Ganti Cover Blog (jpg/png/webp, max 2MB)"
      ...
      <div class="cms-form__actions">
        ...
        <x-button href="{{ route('admin.cms.blogs.index') }}" variant="ghost">Batal</x-button>
        <x-button href="{{ route('admin.cms.blogs.preview', $item) }}" variant="secondary" target="_blank">Preview</x-button>
      </div>
